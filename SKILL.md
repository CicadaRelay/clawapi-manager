...
FreeClaw is an OpenClaw-native tool for managing API keys, monitoring costs, and optimizing API spending through intelligent routing. It saves 30-90% on API costs by automatically routing simple tasks to free models.
...
FreeClaw 是 OpenClaw 原生的 API 管理和成本优化工具。通过智能路由自动将简单任务分配给免费模型，节省 30-90% 的 API 成本。
...
**🐛 问题反馈**: [GitHub Issues](https://github.com/2233admin/freeclaw/issues)  
